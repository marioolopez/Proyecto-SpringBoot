...
public class CategoriaRestControllerTest { //ESTA CLASE ES PARA HACER PRUEBAS UNITARIAS CONTROLLER
	
	@InjectMocks //creas una instancia real del controller (es como si creara la forma real)
	CategoriaRestController categoriaController;
	
	@Mock //gracias a mockito creas un SERVICE false
